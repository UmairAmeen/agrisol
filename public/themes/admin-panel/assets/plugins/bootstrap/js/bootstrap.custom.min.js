! function() {
	...
	! function(o) {
		...
		function s(t, e) {
			var i, o, n, s, r, a, l, p, h, c, u, d = e && e.split("https://demos.qreativethemes.com/"),
				f = b.map,
				g = f && f["*"] || {};
			if (t && "." === t.charAt(0))
				if (e) {
					for (t = t.split("https://demos.qreativethemes.com/"), r = t.length - 1, b.nodeIdCompat && T.test(t[r]) && (t[r] = t[r].replace(T, "")), t = d.slice(0, d.length - 1).concat(t), h = 0; h < t.length; h += 1)
						if (u = t[h], "." === u) t.splice(h, 1), h -= 1;
						else if (".." === u) {
						if (1 === h && (".." === t[2] || ".." === t[0])) break;
						h > 0 && (t.splice(h - 1, 2), h -= 2)
					}
					t = t.join("https://demos.qreativethemes.com/")
				} else 0 === t.indexOf("index.html") && (t = t.substring(2));
			if ((d || g) && f) {
				for (i = t.split("https://demos.qreativethemes.com/"), h = i.length; h > 0; h -= 1) {
					if (o = i.slice(0, h).join("https://demos.qreativethemes.com/"), d)
						for (c = d.length; c > 0; c -= 1)
							if (n = f[d.slice(0, c).join("https://demos.qreativethemes.com/")], n && (n = n[o])) {
								s = n, a = h;
								break
							} if (s) break;
					!l && g && g[o] && (l = g[o], p = h)
				}!s && l && (s = l, a = p), s && (i.splice(0, a, s), t = i.join("https://demos.qreativethemes.com/"))
			}
			return t
		}
