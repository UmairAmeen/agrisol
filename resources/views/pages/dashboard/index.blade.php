...
@section('admin-content')
      ...
      <div class="row">
        <div class="col-6">
          <div class="card-body">
            <div class="card-info mb-3 py-2 mb-lg-1 mb-xl-3">
              ...
              <div class="badge bg-label-success rounded-pill lh-xs">Year of 2021</div>
            </div>
        ...
        <div class="col-6 text-end d-flex align-items-end justify-content-center">
          <div class="card-body pb-0 pt-3 position-absolute bottom-0">
            <img src="../../../demo/assets/img/illustrations/card-ratings-illustration.png" alt="Ratings" width="95">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-3 col-sm-6">
    <div class="card h-100">
      <div class="row">
        ...
        <div class="col-6 text-end d-flex align-items-end justify-content-center">
          <div class="card-body pb-0 pt-3 position-absolute bottom-0">
            <img src="../../../demo/assets/img/illustrations/card-session-illustration.png" alt="Ratings" width="81">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-6">
    <div class="swiper-container swiper-container-horizontal swiper text-bg-success" id="swiper-weekly-sales-with-bg">
      <div class="swiper-wrapper">
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                ...
                <div class="row">
                  <div class="col-6">
                    <ul class="list-unstyled mb-0">
                      <li class="d-flex mb-3 align-items-center">
                        <p class="mb-0 me-2 weekly-sales-text-bg-success">24</p>
                        <p class="mb-0">Mobiles</p>
                      </li>
                      <li class="d-flex align-items-center">
                        <p class="mb-0 me-2 weekly-sales-text-bg-success">12</p>
                  ...
                  <div class="col-6">
                    <ul class="list-unstyled mb-0">
                      <li class="d-flex mb-3 align-items-center">
                        <p class="mb-0 me-2 weekly-sales-text-bg-success">50</p>
                        <p class="mb-0">Accessories</p>
                      </li>
                      <li class="d-flex align-items-center">
                        <p class="mb-0 me-2 weekly-sales-text-bg-success">38</p>
              ...
              <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                <img src="../../../demo/assets/img/products/card-weekly-sales-phone.png" alt="weekly sales" width="230" class="weekly-sales-img">
              </div>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="row">
            ...
            <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
              ...
              <div class="row">
                <div class="col-6">
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex mb-3 align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">16</p>
                      <p class="mb-0">TV's</p>
                    </li>
                    <li class="d-flex align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">40</p>
                ...
                <div class="col-6">
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex mb-3 align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">9</p>
                      <p class="mb-0">Cameras</p>
                    </li>
                    <li class="d-flex align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">18</p>
            ...
            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
              <img src="../../../demo/assets/img/products/card-weekly-sales-controller.png" alt="weekly sales" width="230" class="weekly-sales-img">
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="row">
              ...
              <div class="row">
                <div class="col-6">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">29</p>
                ...
                <div class="col-6">
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex mb-3 align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">43</p>
                      <p class="mb-0">Shoes</p>
                    </li>
                    <li class="d-flex align-items-center">
                      <p class="mb-0 me-2 weekly-sales-text-bg-success">7</p>
            ...
            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
              <img src="../../../demo/assets/img/products/card-weekly-sales-watch.png" alt="weekly sales" width="230" class="weekly-sales-img">
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex">
                <a href="javascript:void(0)" class="me-3">
                  <img src="../../../demo/assets/img/icons/misc/pdf.png" alt="PDF image" width="15" class="me-2">
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/samsung-s22.png" alt="samsung" class="rounded" height="34">
                    </td>
                    <td class="h6 ps-0">Oneplus 9 Pro</td>
                    <td class="text-heading text-end pe-0"><span class="badge rounded-pill bg-label-success">Out of Stock</span></td>
                    <td class="h6 mb-0 text-end pe-0">$12.5k</td>
                    <td class="pe-0 text-end fw-medium h6 text-success">+24%</td>
                  </tr>
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/apple-iPhone-13-pro.png" alt="iphone" class="rounded" height="34">
                    </td>
                  ...
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/oneplus-9-pro.png" alt="us-flag" class="rounded" height="34">
                    </td>
                    <td class="h6 ps-0">Oneplus 9 Pro</td>
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/apple-mac-mini.png" alt="mac-mini" class="rounded" height="34">
                    </td>
                  ...
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/hp-envy-x360.png" alt="hp-envy" class="rounded" height="34">
                    </td>
                  ...
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/dell-inspiron-3000.png" alt="dell" class="rounded" height="34">
                    </td>
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/sony-play-station-5.png" alt="sony-play-station" class="rounded" height="34">
                    </td>
                  ...
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/xbox-series-x.png" alt="xbox" class="rounded" height="34">
                    </td>
                  ...
                  <tr>
                    <td class="ps-0">
                      <img src="../../../demo/assets/img/products/nintendo-switch.png" alt="nintendo-switch" class="rounded" height="34">
                    </td>
  ...
  <div class="col-lg-3 col-sm-6 order-sm-1 order-lg-0">
    <div class="card">
      <div class="card-body pb-0 pt-3">
        <div class="row d-flex align-items-center">
          <div class="col-5 col-lg-6 col-xl-5">
            <div class="chart-progress" data-color="success" data-series="70" data-icon="../../../demo/assets/img/icons/misc/card-icon-laptop.png"></div>
          </div>
      ...
      <div class="card-body pt-0 pb-3">
        <div class="row d-flex align-items-center">
          <div class="col-5 col-lg-6 col-xl-5">
            <div class="chart-progress" data-color="warning" data-series="40" data-icon="../../../demo/assets/img/icons/misc/card-icon-bag.png"></div>
          </div>
          <div class="col-7 col-lg-6 col-xl-7">
            <div class="card-info">
              <div class="d-flex align-items-center gap-2 flex-wrap">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide pb-3">
          ...
          <div class="d-flex align-items-center mt-3">
            <img src="../../../demo/assets/img/products/card-marketing-expense-logo.png" alt="Marketing and sales" width="84" class="rounded">
          ...
          <div class="mt-3 pt-1">
            <button type="button" class="btn btn-sm btn-outline-success me-3">Details</button>
        ...
        <div class="swiper-slide pb-3">
          ...
          <div class="d-flex align-items-center mt-3">
            <img src="../../../demo/assets/img/products/card-accounting-logo.png" alt="Marketing and sales" width="84" class="rounded">
            <div class="d-flex flex-column w-100 ms-4">
        ...
        <div class="swiper-slide pb-3">
          ...
          <div class="d-flex align-items-center mt-3">
            <img src="../../../demo/assets/img/products/card-sales-overview-logo.png" alt="Marketing and sales" width="84" class="rounded">
            <div class="d-flex flex-column w-100 ms-4">
