      ...
      <div class="breadcrumbs">
        <div class="container">
          ...
          <span property="itemListElement" typeof="ListItem">
            <a property="item" typeof="WebPage" title="Go to The Landscaper." href="https://demos.qreativethemes.com/thelandscaper" class="home">
              <span property="name">The Landscaper</span>
            </a>
            <meta property="position" content="1">
          </span>
          <span property="itemListElement" typeof="ListItem">
            <a property="item" typeof="WebPage" title="Go to the Patio Portfolio Category archives." href="../../portfolio_category/patio/index.html" class="taxonomy portfolio_category">
              <span property="name">Patio</span>
            </a>
            <meta property="position" content="2">
          </span>
          <span property="itemListElement" typeof="ListItem">
            <span property="name">Walkout Patio</span>
      ...
      <div class="content">
          ...
          <div class="row">
            <main class="col-xs-12">
              <article class="post-inner post-2657 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-patio">
                <h1 class="widget-title">Walkout Patio</h1>
                <div class="row">
        ...
        <nav class="project-navigation">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <a href="../bistro-terrace/index.html" rel="prev">
                  <i class="fas fa-caret-left"></i> Previous </a>
                <a href="../../galleries/index.html" class="summary">
                  <i class="fas fa-th-list"></i>
                </a>
                <a href="../garden-pond/index.html" rel="next">Next <i class="fas fa-caret-right"></i>
                </a>
              </div>
            </div>
          </div>
