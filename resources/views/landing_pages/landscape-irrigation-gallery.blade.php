...
<div class="page-header">
        <div class="container">
          <h2 class="main-title">Landscape Irrigation Gallery</h2>
      ...
      <div class="breadcrumbs">
        <div class="container">
          ...
          <span property="itemListElement" typeof="ListItem">
            <span property="name">Landscape Irrigation Gallery</span>
          ...
          <div class="row">
            <main class="col-xs-12">
              <article class="post-inner post-2657 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-patio">
                <h1 class="widget-title">Landscape Irrigation Gallery</h1>
                <div class="row">
          ...
          <div class="container">
            <div class="row">
              ...
              <!--   <a href="../bistro-terrace/index.html" rel="prev">
                ...
                <a href="{{route('drip-irrigation-gallery')}}" rel="next">Next <i class="fas fa-caret-right"></i>
                </a>
              </div>
            </div>
          </div>
