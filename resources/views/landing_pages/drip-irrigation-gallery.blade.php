...
<div class="page-header">
        <div class="container">
          <h2 class="main-title">Drip Irrigation Gallery</h2>
      ...
      <div class="breadcrumbs">
        <div class="container">
          ...
          <span property="itemListElement" typeof="ListItem">
            <span property="name">Drip Irrigation Gallery</span>
      ...
      <div class="content">
          ...
          <div class="row">
            <main class="col-xs-12">
              <article class="post-inner post-2657 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-patio">
                <h1 class="widget-title">Drip Irrigation Gallery</h1>
                <div class="row">
        ...
        <nav class="project-navigation">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <a href="{{route('landscape-irrigation-gallery')}}" rel="prev">
                  <i class="fas fa-caret-left"></i> Previous </a>
                <a href="{{route('home.galleries')}}" class="summary">
                  <i class="fas fa-th-list"></i>
                </a>
                <a href="{{route('sprinkler-irrigation-gallery')}}" rel="next">Next <i class="fas fa-caret-right"></i>
                </a>
              </div>
            </div>
          </div>
