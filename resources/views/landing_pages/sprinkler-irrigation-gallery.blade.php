...
<div class="page-header">
        <div class="container">
          <h2 class="main-title">Professional Training Gallery</h2>
      ...
      <div class="breadcrumbs">
        <div class="container">
          ...
          <span property="itemListElement" typeof="ListItem">
            <span property="name">Professional Training Gallery</span>
      ...
      <div class="content">
          ...
          <div class="row">
            <main class="col-xs-12">
              <article class="post-inner post-2657 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-patio">
                <h1 class="widget-title">Professional Training Gallery</h1>
                <div class="row">
        ...
        <nav class="project-navigation">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <a href="{{route('solar-tube-well-gallery')}}" rel="prev">
