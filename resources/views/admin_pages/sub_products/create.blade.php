...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Sub Products /</span><span> Add Sub Product</span>
</h4>
...
<div class="app-ecommerce">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    ...
    <div class="d-flex align-content-center flex-wrap gap-3">
      ...
      <button type="submit" class="btn btn-success">Publish Sub product</button>
    </div>
  </div>
    ...
    <div class="col-12 col-lg-8">
      ...
      <div class="card mb-4">
        <div class="card-header">
          <h5 class="card-tile mb-0">Sub Product information</h5>
        </div>
        <div class="card-body">
        ...
        <div class="card-body">
          <form action="https://demos.pixinvent.com/upload" class="dropzone needsclick" id="dropzone-basic">
            <div class="dz-message needsclick my-5">
              ...
              <span class="needsclick btn btn-outline-success d-inline" id="btnBrowse">Browse image</span>
            </div>
            <div class="fallback">
                ...
                <div class="tab-pane fade show active" id="restock" role="tabpanel">
                  ...
                  <div class="row mb-3 g-3">
                    ...
                    <div class="col-6 col-sm-4 d-grid col-lg-6 col-xxl-4">
                      <button class="btn btn-success btn-lg"><i class='mdi mdi-check me-2'></i>Confirm</button>
                    </div>
                  </div>
                  <div>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-4 col ecommerce-select2-dropdown d-flex justify-content-between">
            ...
            <div>
              <button class="btn btn-outline-success btn-icon btn-lg h-px-50">
